...
values (1, 'Warsaw', 'Poland', 52.242196, 21.015816, '00-325', 'Krakowskie Przedmieście 42/44'),
       ...
       (3, 'Warsaw', 'Poland', 52.227837, 21.004423, '00-697', 'al. Jerozolimskie 65/79');
...
values ('1', 30, 1, 1, 1, 2, 'Luxury Marriott hotel in center of Warsaw', 'Marriott', 'hotel', 2, 2),
       ...
       ('3', 40, 1, 1, 1, 2, 'Luxury Bristol hotel', 'Bristol without images', 'hotel', 3, 1);
...
replace into reservation_entity (id, start_date, end_date, adults, children, pets, special_requests, cancelled,
                                 flat_entity_id,
                                 user_entity_id)
