...
insert into reservation_entity (id, start_date, end_date, adults, children, pets, special_requests, flat_entity_id,
                                user_entity_id)
values (1, '2024-01-01', '2024-01-07', 1, 0, 0, 'Comfy pillow', '2', 1002),
       ...
       (6, '2025-01-27', '2025-02-05', 2, 0, 0, null, '1', 1003),
       (7, '2025-02-16', '2025-03-02', 2, 0, 0, null, '1', 1003),
       (8, '2025-12-20', '2026-02-20', 2, 0, 0, null, '1', 1003),
       (9, '2025-11-20', '2026-02-20', 2, 0, 0, null, '2', 1003),
       (10, '2026-03-20', '2026-05-20', 2, 0, 0, null, '2', 1003),
       (11, '2027-01-01', '2029-01-01', 2, 0, 0, null, '2', 1003);
